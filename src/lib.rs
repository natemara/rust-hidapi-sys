...
use libc::{c_char, c_int, c_uchar, c_ushort, size_t, wchar_t};
...
#[cfg_attr(
	...
	link(name = "hidapi-libusb", kind = "static")
)]
#[cfg_attr(
	all(not(feature = "static"), target_os = "linux"),
	link(name = "hidapi-libusb")
)]
#[cfg_attr(
	all(feature = "static", not(target_os = "linux")),
	link(name = "hidapi", kind = "static")
)]
#[cfg_attr(
	all(not(feature = "static"), not(target_os = "linux")),
	link(name = "hidapi")
)]
extern "C" {
